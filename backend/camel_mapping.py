...
CAMEL_TO_CATEGORY_LABEL: List[Tuple[str, str, str, Optional[str]]] = [
    ...
    # الصوت (vox)
    ("vox", "a", "الصوت", "مبني للمعلوم"),
    ("vox", "a", "الصوت", "صوت معلوم"),
    ("vox", "p", "الصوت", "مبني للمجهول"),
    ("vox", "p", "الصوت", "صوت مجهول"),
    # مزاج الفعل (mod)
    ("mod", "i", "مزاج الفعل", "فعل مرفوع"),
    ("mod", "j", "مزاج الفعل", "فعل مجزوم"),
    ("mod", "j", "مزاج الفعل", "مزاج جازم"),
    ("mod", "s", "مزاج الفعل", "فعل منصوب"),
    # إعراب الاسم (cas)
    ("cas", "n", "إعراب الاسم", "اسم مرفوع"),
    ("cas", "a", "إعراب الاسم", "اسم منصوب"),
    ("cas", "g", "إعراب الاسم", "اسم مجرور"),
    ("cas", "g", "إعراب الاسم", "حالة جر"),
    # شخص الفعل (per)
    ("per", "1", "شخص الفعل", "متكلم"),
    ("per", "2", "شخص الفعل", "مخاطب"),
    ("per", "3", "شخص الفعل", "غائب"),
    ("per", "3", "شخص الفعل", "شخص غائب"),
    # العقلانية (rat)
    ("rat", "y", "العقلانية", "عاقل"),
    ("rat", "y", "العقلانية", "مسند عاقل"),
    ("rat", "n", "العقلانية", "غير عاقل"),
    ("rat", "n", "العقلانية", "مسند غير عاقل"),
]
